(function ($) {
    ...
    var countDownTimer = function(){
        ...
        var x = setInterval(function() { 
            ...
            document.getElementById("clock").innerHTML="<div>"+0+" <span>Months</span></div> <div>"+days+" <span>Days</span></div> <div>"+hours+" <span>Hours</span></div> <div>"+minutes+" <span>Minutes</span></div> <div>"+seconds+" <span>Seconds</span></div>";
        }, 1000); 
        return;
    }
    // countDownTimer();
